package core.lecture3_08_Reflection.practice.cho.string_processor;
...
public class StringProcessor {
	final String sourceFile = "bin/core/lecture3_08_Reflection/practice/cho/string_processor/StrTest.java";

	void genSource(String expression) {
		try (PrintWriter out = new PrintWriter(sourceFile)) {
			out.println("package core.lecture3_08_Reflection.practice.cho.string_processor;");
			out.println("public class StrTest {");
	...
	public static void main(String[] args) {
		...
		try {
			if (sp.compile()) {
				...
				Class<?> cls = Class.forName("core.lecture3_08_Reflection.practice.cho.string_processor.StrTest");
