...
////
////author: Marty Stepp, 2009/03/06; modified 2012/02/28
...
//     }
//
//     // print info about how many bytes were saved/used
//     File inputFile = new File(inputFileName);
//     File outputFile = new File(outputFileName);
//     long inSize = inputFile.length();
//     long outSize = outputFile.length();
//     double compression = inSize == 0 ? 0 : 100.0 * (inSize - outSize) / inSize;
//     System.out.printf("%d => %d bytes (%.1f%% compression)\n", inSize, outSize, compression);
//
//     return startTime;
// }
//
