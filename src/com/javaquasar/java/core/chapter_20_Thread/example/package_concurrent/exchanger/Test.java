package com.javaquasar.java.core.chapter_20_Thread.example.package_concurrent.exchanger;
...
/*Exchanger (обменик)
 ...
 Предположим один поток формирует данные, а другой записывает эти данные в файл. Поэтому
