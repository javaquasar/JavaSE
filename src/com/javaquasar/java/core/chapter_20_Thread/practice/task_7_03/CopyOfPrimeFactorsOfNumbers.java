package com.javaquasar.java.core.chapter_20_Thread.practice.task_7_03;
...
public class CopyOfPrimeFactorsOfNumbers {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CopyOfPrimeFactorsOfNumbers window = new CopyOfPrimeFactorsOfNumbers();
	 ...
	 */
	public CopyOfPrimeFactorsOfNumbers() {
		initialize();
	}
	...
	private void initialize() {
		...
		gridBagLayout.columnWidths = new int[] { 50, 50, 50, 50, 0, 0 };
