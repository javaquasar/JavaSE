...
public class StringProcessor {
	final String sourceFile = "com/javaquasar/java/core/chapter_27_Reflection/StrFun.java";
	...
	public static void main(String[] args) {
		...
		try {
			if (sp.compile()) {
				...
				Class<?> cls = Class.forName("com.javaquasar.java.core.chapter_27_Reflection.StrFun");
